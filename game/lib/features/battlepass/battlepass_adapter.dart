/// 배틀패스 시스템 어댑터 - MG-0007 Pixel Farm Tycoon
library;
...
/// Pixel Farm Tycoon 배틀패스
class FarmBattlePass extends ChangeNotifier {
  ...
  Map<String, Object> get missionProgress => _manager.state?.missionProgress ?? {};
