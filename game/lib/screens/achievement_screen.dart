...
// ============================================================
// Achievement Screen — MG-0007 Idle Runner
// Genre: Idle · Retention System UI
//
// Firebase Analytics Events:
//   - achievement_screen_viewed: {total_achievements, unlocked_count}
//   - achievement_tab_changed:   {category}
//
...
/// Achievement screen for MG-0007 Idle Runner.
///
...
class _AchievementScreenState extends State<AchievementScreen>
  ...
  static const Map<String, AchievementCategory> _categoryMap = {'first_100': AchievementCategory.progression, 'marathon_runner': AchievementCategory.progression, 'time_master': AchievementCategory.special};

  static const Map<String, int> _pointsMap = {'first_100': 15, 'marathon_runner': 25, 'time_master': 50};
