...
이 프로젝트는 **픽셀 농장 타이쿤**의 Flutter 구현체입니다.
...
| 문서 | 설명 |
|------|------|
| [docs/design/gdd_game_0007.json](docs/design/gdd_game_0007.json) | 게임 디자인 문서 |
...
**HUD 파일**: [game/lib/ui/hud/mg_runner_hud.dart](game/lib/ui/hud/mg_runner_hud.dart)
